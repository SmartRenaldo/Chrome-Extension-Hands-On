chrome.runtime.onMessage.addListener(
  function (request, sender, sendResponse) {
    try {
      ...
      document.getElementById("credit_card_number").value = request.card_number;
      document.getElementById('credit_card_month').value = request.card_month;
      document.getElementById('credit_card_year').value = request.card_year;
      document.getElementById("credit_card_verification_value").value = request.card_cvv; 
